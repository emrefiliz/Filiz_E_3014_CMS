...
(5, 'beauty.jpg', 'Beauty and the Beast', '2017', '2h 9m', 'An adaptation of the fairy tale about a monstrous-looking prince and a young woman who fall in love. ', 'Beauty.mp4', 'March 17, 2017'),
...
(22, 'nightcrawler.jpg', 'Nightcrawler', '2014', '1h 58m', 'When Louis Bloom, a con man desperate for work, muscles into the world of L.A. crime journalism, he blurs the line between observer and participant to become the star of his own story.', 'Nightcrawler.mp4', 'September 5, 2014'),
(23, 'inland.jpg', 'Inland Empire', '2006', '3h 17m', 'As an actress starts to adopt the persona of her character in a film, her world starts to become nightmarish and surreal.', 'Inland.mp4', 'September 6, 2006'),
(24, 'existenz.jpg', 'eXistenZ', '1999', '1h 37m', 'A game designer on the run from assassins must play her latest virtual reality creation with a marketing trainee to determine if the game has been damaged.', 'existenz.mp4', 'February 16, 1999'),
(25, 'vertigo.jpg', 'Vertigo', '1958', '2h 8m', 'A San Francisco detective suffering from acrophobia investigates the strange activities of an old friend\'s wife, all the while becoming dangerously obsessed with her.', 'vertigo.mp4', 'May 9, 1958');
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_ip`, `user_level`, `user_last_login`, `user_failed_login_attempts`, `user_suspended`) VALUES
(1, 'Emre Filiz', 'emre', '1234', 'e_filiz@fanshawec.ca', '2018-02-15 00:00:00', '::1', 2, '2018-04-16 20:54:51', 0, 0),
(2, 'Jane Doe', 'jane', '1234', 'j_doe@fanshawec.ca', '2018-02-15 01:00:00', '::1', 1, '2018-02-15 01:01:00', 2, 0),
(3, 'Justin Brunner', 'justin', '1234', 'jbrunner@fanshawec.ca', '2018-02-15 03:00:00', '::2', 2, NULL, 0, 1);
COMMIT;
